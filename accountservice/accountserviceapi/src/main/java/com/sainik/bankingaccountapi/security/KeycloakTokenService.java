package com.sainik.bankingaccountapi.security;
 ...
 *
 * Used by outbound REST clients (e.g. {@code CustomerServiceClient}) to
 * authenticate inter-service calls without forwarding the end-user's token.
 *
 ...
 *   keycloak.client-id=account-service-client
