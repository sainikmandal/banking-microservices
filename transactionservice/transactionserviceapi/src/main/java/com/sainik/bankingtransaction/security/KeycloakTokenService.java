package com.sainik.bankingtransaction.security;
 ...
 *
 * Used by {@code AccountServiceClient} to authenticate calls to the
 * account-service without forwarding the end-user's token.
 *
 ...
 *   keycloak.client-id=transaction-service-client
